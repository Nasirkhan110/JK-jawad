...
oks = []
twf = []
#os.system('xdg-open https://www.facebook.com/ali.aliadnan.739')
...
\033[1;37m[!]=================================================
\033[1;37m[•]CREATED          :  \033[1;37m Nasir khan
\033[1;37m[•]FACEBOOK         :  \033[1;97m Abdul Nasir
\033[1;37m[•]GITHUB           :  \033[1;37m Nasir-111
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mNasir-OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mNasir-CP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mNasir-2F.txt' %
              (H, P, str(len(twf))))
